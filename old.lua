...
if queueonteleport then
	queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/farmingbackup/loading/main/old.lua'))()")
end
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/farmingbackup/loading/main/UI"))()
local _HIGHLIGHTLOADER = loadstring(game:HttpGet('https://raw.githubusercontent.com/farmingbackup/loading/main/hl.lib.lua'))()
